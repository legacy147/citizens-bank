  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-28">
      <div className="bg-navy text-white p-5 rounded-b-3xl flex items-center gap-3">
        ...
        <span className="font-bold text-lg">Pay Bills</span>
      </div>
      <div className="px-5 -mt-6">
        <div className="bg-white rounded-2xl card-shadow p-8 text-center text-gray-500">
          <Receipt className="mx-auto mb-2 text-navy" size={40} />
          <p className="text-sm font-medium text-gray-700">Pay Bills</p>
          <p className="text-xs text-gray-400 mt-1">Manage your bills here</p>
        </div>
      </div>
      <BottomNav />
    </div>
